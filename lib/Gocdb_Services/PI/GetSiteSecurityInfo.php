...
/**
 * Return an XML document that encodes the site security info from the DB with optional cursor paging.
 ...
 */
class GetSiteSecurityInfo implements IPIQuery, IPIQueryPageable, IPIQueryRenderable {
