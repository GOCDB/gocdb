...
function isBad($site) {
     ...
     * All sites under ROC_IGALC which was closed Apr-2013,
     * all NGI_IE sites closed Jul-2013.
     * PPS-CNAF is a broken site with a production status of pps
     * 15.08.13: Removed 'UFRJ-IF',  from this list as it
     *     appears to be fixed (??)
     * 15.08.13: Removed 'EELA-UNLP',  from this list as it
     *     appears to be fixed (??)
     * 15.08.13: Removed 'ULA-MERIDA', from this list as it
     *     appears to be fixed (??)
     * 15.08.13: Removed 'ZA-MERAKA', 'ZA-WITS-CORE', 'ZA-UJ',
     *     'ZA-CHPC' as NGI_ZA has been reinstated
     */
    $badSites = array('Australia-UNIMELB-LCG2', 'PPS-CNAF', 'GUP-JKU',
            'UNIBAS', 'FZK-PPS', 'MA-01-CNRST', 'EELA-UC', 'CEFET-RJ',
            'CMM-UChile', 'CPTEC-INPE', 'CUBAENERGIA', 'EPN', 'FING',
            'GRID-CEDIA', 'GRyDs-USB', 'INCOR-HCFMUSP', 'UFCG-LSD',
