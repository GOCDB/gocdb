    ...
    if (empty($authPrincipleStr)) {
        ...
        if ($message == null) {
            die(
                ...
                . "A valid user certificate was not found"
            );
            /**
             * or your EGI SSO user account is not associated
 ...
 * with the host url of the incoming request.
 */
/**
 * Allows the overriding of configuration values. Do not use 'new'
 * to create a new instance after this.
 */
