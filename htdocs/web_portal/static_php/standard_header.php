...
function get_standard_header($title = null) {
    ...
    $header .= '
        ...
        <script type="text/javascript" src="'.GocContextPath::getPath().'javascript/fullcalendar/fullcalendar.min.js"></script>
        ...
        <link rel="stylesheet" href="'.GocContextPath::getPath().'javascript/fullcalendar/fullcalendar.min.css" />
