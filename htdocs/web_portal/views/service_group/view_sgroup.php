...
<div class="rightPageContainer">
    <div style="float: left;">
        <img
            src="<?php echo \GocContextPath::getPath(); ?>img/virtualSite.png"
            class="pageLogo"
        />
    </div>
        ...
        <?php if ($params['ShowEdit']) : ?>
            <div style="float: right;">
                <div style="float: right; margin-left: 2em;">
                    <a
                        href="<?php
                            echo "index.php?Page_Type=Edit_Service_Group&amp;",
                                "id=",
                                $params['sGroup']->getId();
                        ?>"
                    >
                ...
                <div style="float: right;">
                    ...
                    <a
                        ...
                        href="index.php?Page_Type=Delete_Service_Group&id=<?php
                            echo $params['sGroup']->getId();
                        ?>"
                    >
                        <img
                            src="<?php
    ...
    <div style="float: left; width: 100%; margin-top: 2em;">
        ...
        <div class="tableContainer" style="width: 55%; float: left;">
            ...
            <table style="clear: both; width: 100%;">
                ...
                <?php
                if (
                    $params['sGroup']->getScopes() != null
                    && $params['sGroup']->getScopes()->first() != null
                    && (
                        $params['sGroup']->getScopes()->first()
                            ->getName() == "Local"
                    )
                ) {
                ...
                <tr class="site_table_row_2" <?php echo $style; ?>>
                    ...
                    <td class="site_table">
                        ...
                        >
                            <?php
                            xecho($params['sGroup']->getScopeNamesAsString());
                            ?>
                        </textarea>
                    </td>
                </tr>
    ...
    >
                        ...
                        <div style="background-color: inherit;">
                            <div style="background-color: inherit;">
                                <span style="vertical-align: middle;">
                                    <a
                                        href="<?php
                                            echo "index.php?Page_Type=Service"
                                                . "&amp;id=" . $se->getId();
                                        ?>"
                                    >
                                        <?php
        ...
        <?php if (!$params['portalIsReadOnly'] && $params['ShowEdit']) : ?>
            ...
            <a
                href="<?php
                    echo "index.php?Page_Type=Add_Service_Group_SEs&amp;id="
                        . $params['sGroup']->getId();
                ?>"
            >
                <img
            ...
            <a
                href="<?php
                    echo "index.php?Page_Type=Remove_Service_Group_SEs&amp;id="
                        . $params['sGroup']->getId();
                ?>"
            >
                <img
    ...
    >
        ...
        if ($showPD) { ?>
            ...
            <img
                src="<?= \GocContextPath::getPath(); ?>img/people.png"
                class="decoration"
            />
        ...
        <?php if (!$params['portalIsReadOnly'] && $showPD) : ?>
            <!-- Request role Link -->
            <a
                href="index.php?Page_Type=Request_Role&amp;id=<?php
                        echo $params['sGroup']->getId();
                ?>"
            >
                <img
    ...
    >
        ...
        <a
            href="index.php?Page_Type=SGroup_Downtimes&amp;id=<?php
                echo $params['sGroup']->getId();
            ?>"
            style="vertical-align: middle;
                float: left;
        ...
        <table style="clear: both; width: 100%;">
            ...
            foreach ($params['downtimes'] as $d) {
                ...
                <tr class="site_table_row_<?php echo $num; ?>">
                    ...
                    <td class="site_table">
                        <?php
                        echo $d->getStartDate()->format($d::DATE_FORMAT);
                        ?>
                    </td>
                    <td class="site_table">
                        <?php
                        echo $d->getEndDate()->format($d::DATE_FORMAT);
                        ?>
                    </td>
                </tr>
                <?php
