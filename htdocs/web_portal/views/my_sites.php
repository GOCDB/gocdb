            ...
            <table style="clear: both; width: 100%; table-layout: fixed;">
                <?php if(!empty($params['sites_from_roles'])) {
                        ...
                        <tr class="site_table_row_<?php echo $num ?>">
                            <td class="site_table">
                                <a href="index.php?Page_Type=Site&id=<?php echo $site->getId()?>"><?php echo $site->getShortName() ?></a>
                            </td>
                        </tr>
        ...
        <div class="tableContainer" style="width: 42%; float: right;" >
            ...
            <table style="clear: both; width: 100%; table-layout: fixed;">
                <?php if(!empty($params['ngis_from_roles'])) {
                        ...
                        <tr class="site_table_row_<?php echo $num ?>">
                            <td class="site_table">
                                <a href="index.php?Page_Type=NGI&id=<?php echo $ngi->getId()?>"><?php echo $ngi->getName()?></a>
                            </td>
                        </tr>
                        <?php if($num == 1) { $num = 2; } else { $num = 1; } } ?>
        ...
        <div class="tableContainer" style="width: 55%; float: left;" >
            ...
            <table style="clear: both; width: 100%; table-layout: fixed;">
                <?php if(!empty($params['sgroups_from_roles'])) {
                        ...
                        <tr class="site_table_row_<?php echo $num ?>">
                            <td class="site_table">
                                <a href="index.php?Page_Type=Service_Group&id=<?php echo $sg->getId()?>"><?php echo $sg->getName()?></a>
                            </td>
                        </tr>
                        <?php if($num == 1) { $num = 2; } else { $num = 1; } } ?>
