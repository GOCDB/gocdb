<div class="rightPageContainer">
    <form name="Update_Group" action="index.php?Page_Type=Edit_NGI" method="post" class="inputForm">
    	...
    	<h1><?php echo $params['ngi']->getName() ?></h1>
    	<br />
        ...
        <input class="input_input_text" type="text" name="EMAIL" value="<?php echo $params['ngi']->getEmail(); ?>">
        ...
        <input class="input_input_text" type="text" name="HELPDESK_EMAIL" value="<?php echo $params['ngi']->getHelpdeskEmail(); ?>">
        ...
        <input class="input_input_text" type="text" name="ROD_EMAIL" value="<?php echo $params['ngi']->getRodEmail(); ?>">
        ...
        <input class="input_input_text" type="text" name="SECURITY_EMAIL" value="<?php echo $params['ngi']->getSecurityEmail(); ?>">
        ...
        <input class="input_input_text" type="text" name="GGUS_SU" value="<?php echo $params['ngi']->getGgus_Su(); ?>">
