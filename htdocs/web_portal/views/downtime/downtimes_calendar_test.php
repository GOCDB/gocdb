...
//            }
            ...
            $(document).ready(function () {
                ...
                calendar.fullCalendar({
                    ...
                    header: false,
                    events: {
                        url: '/portal/index.php?Page_Type=Downtimes_Calendar_Test&getDowntimesAsJSON',
                        data: function(){
                            console.log("#############################################");
                    ...
                    eventRender: function eventRender(event, element, view) {
                        ...
                        //tooltip setup
                        element.attr('data-tooltipURL', '/portal/index.php?Page_Type=Downtimes_Calendar_Test&getTooltip&downtimeID=' + event.id);
                        element.qtip({
                            content: {
